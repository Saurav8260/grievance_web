...
// <div className="flex flex-wrap items-center justify-between gap-4 mb-6 max-w-screen-xl">
//   <div>
...
//     className="h-10 px-4 bg-blue-600 text-white rounded-md text-sm whitespace-nowrap"
//   >
//     + Add Grievance
//   </button>
// </div>
