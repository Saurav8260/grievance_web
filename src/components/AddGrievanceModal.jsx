...
//         setFileError("Only jpg, jpeg, png, pdf, doc, docx files are allowed");
//         return;
//       }
...
//       if (!form.name.trim())
//         errors.name = "Citizen Name is required";

//       if (!form.fatherSpouseName.trim())
//         errors.fatherSpouseName = "Father / Spouse Name is required";
...
//         errors.gp = "GP is required";

//       if (form.block === "Athagarh NAC" && !form.wardNo)
//         errors.wardNo = "Ward No is required";

//       if (!form.villageSahi)
//         errors.villageSahi = "Village / Sahi is required";

//       if (!form.grievanceDetails.trim())
//         errors.grievanceDetails = "Grievance Details is required";
...
//         block: form.block,
//         gp: form.block === "Athagarh NAC" ? "N/A" : form.gp,
...
//       onClose();
//     } catch (err) {
//       setError("Failed to save grievance");
//     } finally {
//       setLoading(false);
//     }
//   };
...
//         <Input label="Citizen Name" name="name" value={form.name} onChange={handleChange} error={fieldErrors.name} />
//         <Input label="Father / Spouse" name="fatherSpouseName" value={form.fatherSpouseName} onChange={handleChange} error={fieldErrors.fatherSpouseName} />
//         <Input label="Contact" name="contact" value={form.contact} onChange={handleChange} error={fieldErrors.contact} />

//         <Select label="Block" name="block" value={form.block} options={blocks} onChange={handleChange} error={fieldErrors.block} />

//         {form.block === "Athagarh NAC" ? (
//           <>
//             <Select label="Ward No" name="wardNo" value={form.wardNo} options={wards} onChange={handleChange} error={fieldErrors.wardNo} />
//             <Select label="Village / Sahi" name="villageSahi" value={form.villageSahi} options={villages} onChange={handleChange} error={fieldErrors.villageSahi} />
//           </>
//         ) : (
//           <>
//             <Select label="GP" name="gp" value={form.gp} options={gps} onChange={handleChange} error={fieldErrors.gp} />
//             <Select label="Village / Sahi" name="villageSahi" value={form.villageSahi} options={villages} onChange={handleChange} error={fieldErrors.villageSahi} />
//             <Select label="Ward No" name="wardNo" value={form.wardNo} options={wards} onChange={handleChange} />
//           </>
//         )}
...
//                 return (
//                   <div key={index} className="border rounded-lg overflow-hidden text-xs">
//                     {isImage && (
//                       <img src={fileUrl} alt={file.name} className="w-full h-32 object-cover" />
//                     )}
//                     <div className="p-2">
...
//           rows={4}
//           readOnly={readOnly}
//           className={`w-full border rounded-md px-3 py-2 text-sm ${error ? "border-red-500" : ""}`}
//         />
//       ) : (
//         <input
//           name={name}
...
const villages =
 ...
 const wards =
  form.block === "Athagarh NAC"
    ? Object.keys(locationMaster[form.block] || {}).sort(
        (a, b) => Number(a) - Number(b)
      )
    : form.villageSahi && form.block && form.gp
    ? [...locationMaster[form.block][form.gp][form.villageSahi]].sort(
        (a, b) => Number(a) - Number(b)
      )
    : [];
